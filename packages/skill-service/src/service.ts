...
const BUILTIN_SKILLS: SkillDefinition[] = [
  ...
  },
  {
    id: "style_extract",
    name: "风格提取",
    description: "从样文中提取可复用的写作风格规则。",
    input_mode: "text",
    context_requirements: ["style"],
    handler_type: "prompt",
    linked_targets: ["00_设定集/风格库/写作风格.txt"],
    prompt: "你是写作风格分析师。请从输入样文里提炼句长偏好、对白密度、叙事节奏、禁用词和情绪浓度，不要复述剧情。",
    imported_from: "",
    writable: true
  },
  {
    ...
    prompt: "你是小说题材设定编辑。请根据用户输入生成可约束后续写作的题材库，必须包含题材规则、题材素材、战斗模板、违禁词四段。",
    imported_from: "",
    writable: true
  },
  {
