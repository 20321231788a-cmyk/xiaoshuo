...
export const apiContracts = {
  ...
  agentRunExport: { method: "GET", path: "/api/agent/runs/{run_id}/export", response: agentRunExportSchema },
  deleteAgentRun: { method: "DELETE", path: "/api/agent/runs/{run_id}", response: agentRunDeleteResponseSchema },
