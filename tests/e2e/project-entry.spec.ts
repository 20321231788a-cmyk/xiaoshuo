...
test("assistant reference candidates are included without blocking the conversation", async ({ page }) => {
  ...
  await expect(page.getByRole("region", { name: "确认参考文件" })).toHaveCount(0);
});
